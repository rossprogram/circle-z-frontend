...
<v-form :key="key">
  <v-container fluid>
    <v-row><v-col><v-card>
	  ...
	  <v-card-subtitle>You may optionally upload a <em>curriculum vitae</em>, a résumé, or any other documents which would help the Admissions Committee understand your accomplishments.  Your Short Essays may also be uploaded here. Please use PDF format for all uploaded documents.</v-card-subtitle>
